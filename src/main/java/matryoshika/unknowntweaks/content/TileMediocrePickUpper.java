...
public class TileMediocrePickUpper extends TileEntity implements ITickable {
	...
	public void update() {
		if (!this.world.isRemote) {
			...
			if (TICKS >= 20) {
				...
				List<EntityItem> ents = this.world.getEntitiesWithinAABB(EntityItem.class, UTUtils.getBB(getPos(), 4), EntitySelectors.IS_ALIVE);
