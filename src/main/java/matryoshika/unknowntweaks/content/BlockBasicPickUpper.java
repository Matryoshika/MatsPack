...
public class BlockBasicPickUpper extends BlockDirectional {

	public BlockBasicPickUpper() {
		super(Material.IRON);
		setRegistryName(new ResourceLocation(UnknownTweaks.MODID, "basic_pickupper"));
